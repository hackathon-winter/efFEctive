...
def list_questions(request):
    ...
    return render(request, 'questions/question.html', {'user_answers_count':user_answers_count,'question_id':question.id,'question_content':question_content,'question_choices':question_choices}) 
